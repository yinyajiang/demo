...
class CommonSeparator:
    ...
    def __init__(self, config):
        ...
        self.is_bv_model = self.model_data.get("is_bv_model", False) #BV = Backing Vocals（和声人声），Lead Vocals: 主唱人声  
        self.bv_model_rebalance = self.model_data.get("is_bv_model_rebalanced", 0) # 用于调整和声与主唱的音量平衡
